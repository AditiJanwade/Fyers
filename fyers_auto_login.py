...
# Client Info fetched from .env
FY_ID = os.getenv("FY_ID")
TOTP_KEY = os.getenv("TOTP_KEY")
PIN = os.getenv("PIN")

# App Specific Credentials fetched from .env
...
def main():
    ...
    # Save to .env
    env_file = ".env"
    set_key(env_file, "ACCESS_TOKEN", validate_authcode_result[1])
    set_key(env_file, "CLIENT_ID", f"{APP_ID}-{APP_TYPE}")
